...
<%@ page import="be.intecbrussel.entity.Transaction" %>
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        <tbody>
                            ...
                            <%
    List<Transaction> pList = myController.showTransactionLog(myController.findByBankAccountNumber(from_bankAccountNumber).getId_account());
    for (Transaction transaction : pList) {
